...
aws s3api create-bucket --bucket organization-audit-logs
...
aws s3api put-bucket-policy --bucket organization-audit-logs --policy file://trail-bucket-policy.json
...
aws cloudtrail start-logging --name GlobalAuditTrail
```
